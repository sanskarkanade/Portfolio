...
const skills = [
  ...
  { name: 'Node.js', symbol: <SiNodedotjs className="text-green-600 text-5xl" /> },
  { name: 'Express', symbol: <SiExpress className="text-gray-300 text-5xl" /> },
  { name: 'MongoDB', symbol: <SiMongodb className="text-green-700 text-5xl" /> },
    ...
    <div className="pt-16 bg-gradient-to-r from-black via-gray-900 to-black text-white min-h-screen">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
        {skills.map((skill, index) => (
          <div
            key={index}
            className="p-4 bg-gray-800 rounded-lg shadow-md hover:scale-105 transition-transform duration-300"
          >
